...
const refreshPlayerList = () => {
    ...
    const ul = document.querySelector(".js-challengelist") as HTMLUListElement;
...
export function addChallenge(playerInfo: IPlayerInfo, callback: (opponent: IPlayerInfo) => void) {
    playerInfo.callback = callback;
    playerList.push(playerInfo);
    refreshPlayerList();
}

export function removeChallenge(playerInfo: IPlayerInfo) {
    let deleteIdx = -1;
